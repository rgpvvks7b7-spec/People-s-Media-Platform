...
class ArtistDashboardTests(APITestCase):
    ...
    def test_artist_dashboard_aggregates_business_health(self):
        ...
        self.assertEqual(response.data["revenue"]["platform_fees_this_month"], "1.70")
        self.assertEqual(response.data["revenue"]["artist_share_this_month"], "15.30")
    ...
    def test_artist_dashboard_exposes_fee_schedule(self):
        ...
        self.assertEqual(items["tips"]["you_keep_percent"], "90%")
