...
from .views import commission_requests, create_cart_checkout, create_product, create_purchase_checkout, download_product_file, my_purchases, preview_product_audio, product_list, purchase_product, update_commission_request

urlpatterns = [
    path("", product_list),
    path("create/", create_product),
    path("files/<int:product_id>/download/", download_product_file),
    path("files/<int:product_id>/preview/", preview_product_audio),
